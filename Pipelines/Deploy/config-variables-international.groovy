...
//py2 service yamls
    APP_SERVICE_YAML = RELEASE_SCOPE == "beta" ? '' : (RELEASE_SCOPE == "sprint") ? "time2eat_appservice_demo.yaml" : (RELEASE_SCOPE == "preprod") ? "time2eat_appservice_preprod.yaml" : "time2eat_appservice.yaml"
